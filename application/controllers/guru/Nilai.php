...
class Nilai extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            'pengampu'  => $this->Model_guru_kelas->get_mapel_pengampu($guru['id_guru']),
            'menu'      => 'nilai',
            'breadcrumb' => [
                0 => (object)[
                    'name' => 'Dashboard',
    ...
    public function get_mapel()
    {
        ...
        $data       = $this->Model_guru_kelas->get_mapel_pengampu($id_guru, $id_kelas);
    ...
    public function kd()
    {
        ...
        $this->load->view('_partials/navbar.php', $data);
        $this->load->view('_partials/sidebar.php', $data);
        $this->load->view('guru/nilai_perkd.php', $data);
        $this->load->view('_partials/footer.php');
    }
    ...
    public function input()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('_partials/navbar.php', $data);
            $this->load->view('_partials/sidebar.php', $data);
            $this->load->view('guru/nilai_input.php', $data);
            $this->load->view('_partials/footer.php');
        } else {
    ...
    public function edit()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('_partials/navbar.php', $data);
            $this->load->view('_partials/sidebar.php', $data);
            $this->load->view('guru/nilai_edit.php', $data);
            $this->load->view('_partials/footer.php');
        } else {
    ...
    public function archivedata()
    {
        ...
        $data = array(
            'id_user'       => $data['id_user'],
            'nama'          => $data['nama_guru'],
            'foto_guru'         => $data['foto_guru'] != null ? $data['foto_guru'] : 'user-placeholder.jpg',
            'level'         => $data['level'],
            'id_kelas'      => $id_kelas,
            'id_mapel'      => $id_mapel,
            'jenis_nilai'   => $nilai,
        ...
        $this->load->view('_partials/navbar.php', $data);
        $this->load->view('_partials/sidebar.php', $data);
        $this->load->view('guru/nilai_arsip.php', $data);
        $this->load->view('_partials/footer.php');
    }
