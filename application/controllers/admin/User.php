...
class User extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data = array(
            ...
            'count_guru'    => $this->User_model->count_user('guru', 'kepala sekolah'),
            'count_wali'    => $this->User_model->count_user('kepala sekolah'),
        ...
        $this->load->view('dashboard/admin/user.php', $data);
