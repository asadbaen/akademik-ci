...
class Tahun_ajaran extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('dashboard/tahun_ajaran/tahun.php', $data);
    ...
    function get_result_tahun()
    {
        ...
        foreach ($list as $item) {
            ...
            $row[] = anchor('admin/tahun_ajaran/edit/' . $item->id_tahun, '<div class="btn btn-sm btn-primary btn-xs mr-1 ml-1 mb-1"><i class="fa fa-edit"></i></div>')
    ...
    public function input()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('_partials/navbar.php', $data);
            $this->load->view('_partials/sidebar.php', $data);
            $this->load->view('dashboard/tahun_ajaran/tahun_input.php', $data);
            $this->load->view('_partials/footer.php');
        } else {
    ...
    public function edit()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->load->view('_partials/navbar.php', $data);
            $this->load->view('_partials/sidebar.php', $data);
            $this->load->view('dashboard/tahun_ajaran/tahun_edit.php', $data);
            $this->load->view('_partials/footer.php');
        } else {
