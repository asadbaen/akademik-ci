<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-sort-numeric-down"></i> Input Nilai <?= $mapel['nama_mapel'] . ' / Kelas ' . $kelas['nama_kelas'] ?> <?= $thn = ($tahun) ? '(Tahun Ajaran ' . $tahun['nama'] . ' - Semester ' . $tahun['semester'] . ')' : '(Tidak Ada Tahun Ajaran Yang Aktif)';  ?> - <?= $jenis_penilaian ?></h1>
    </div>
        ...
        <dic class="card-body">
            <form action="" method="post">
                <div class="mb-3 row form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" name="nama" id="nama" value="<?= $pengajar['nama_guru'] ?>" class="form-control-plaintext" readonly="readonly">
                    </div>
                </div>
                <div class="mb-3 row form-group">
                    <label for="nama" class="col-sm-2 col-form-label">
                            ...
                            <tbody>
                                <?php foreach ($siswa as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div class="form-group">
                                                <input type="text" name="nama<?= $key ?>" id="nama<?= $key ?>" value="<?= $value->nama_siswa ?>" class="form-control-plaintext" readonly="readonly">
                                            </div>
                                        </td>
                                        <td>
                                            <div class="form-group">
