<div class="container-fluid">
    ...
    <div class="alert alert-success" role="alert">
        ...
        <p>Selamat Datang <strong><?php echo $nama; ?></strong> di Sistem Informasi Pengolahan Data Nilai SMP AL -Ghuroba', Anda Login Sebagai <strong><?php echo $level; ?></strong></p>
