                ...
                <div class="col-sm-3" class="text-center">
                    ...
                    <div id="photo" class="mb-3">
                        <?php if ($guru['foto_guru']) : ?>
                            <img src="<?= base_url('uploads/' . $guru['foto_guru']) ?>" alt="photo <?= $guru['nama_guru'] ?>" style="width: 200px; height: 300px; border-radius: 15px;">
                        <?php else : ?>
                            <img src="<?= base_url('assets/photos/user-placeholder.jpg') ?>" alt="photo <?= $guru['nama_guru'] ?>" style="width: 200px; height: 300px; border-radius: 15px;">
                        <?php endif ?>
                    </div>
                </div>
                <div class="col-sm-9">
                        ...
                        <div class="card-body">
                            <table class="table table-borderless no-margin table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><span id="nama"><?= $guru['nama_guru'] ?></span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><span id="Tempat_lahir"><?= $guru['Tempat_lahir'] ?></span></td>
                                </tr>
                                <tr>
                                    <th class="text-left">No. Handphone</th>
                                    <td><span id="no-hp"><?= $guru['No_telpon'] ?></span></td>
                                </tr>
                                <tr>
