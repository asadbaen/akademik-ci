            ...
            <div class=" col-md-12">
                            ...
                            <tbody>
                                <?php foreach ($contents["jadwal"] as $key => $value) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <a href="<?= base_url("admin/absensi/isi_absensi/$value->id_jadwal/$value->kelas_id/$value->mapel_id") ?>" class="btn btn-info btn-sm"><i class="fa fa-edit"></i> Isi Absensi</a>&emsp;
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
                ...
                <script>
                    function filter() {
                        ...
                        if (filter != "") {
                            window.location = "<?= base_url("admin/absensi/index") ?>?hari=" + filter;
                        }
                    }
                </script>
