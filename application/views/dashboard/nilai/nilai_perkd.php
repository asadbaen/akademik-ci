...
<section class="content">
    ...
    <div class="container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800"><i class="fas fa-sort-numeric-down"></i> Detail Nilai <?= $mapel['nama_mapel'] . ' / Kelas ' . $kelas['nama_kelas'] ?> <?= $thn = ($tahun) ? '(Tahun Ajaran ' . $tahun['nama'] . ' - Semester ' . $tahun['semester'] . ')' : '(Tidak Ada Tahun Ajaran Yang Aktif)';  ?> - <?= $jenis_nilai ?></h1>
        </div>
    ...
    <script>
        function lihatNilai() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?php echo base_url('admin/nilai/data_nilai_perkd') ?>',
                data: {
                    id_kelas: idKelas,
                    id_mapel: idMapel,
                    id_kd: idKd,
