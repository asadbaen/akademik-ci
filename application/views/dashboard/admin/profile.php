            ...
            <div class="row">
                <div class="col-sm-3" class="text-center">
                    ...
                    <div id="photo" class="mb-3">
                        <?php if ($admin['foto']) : ?>
                            <img src="<?= base_url('uploads/' . $admin['foto']) ?>" alt="photo <?= $admin['nama'] ?>" style="width: 200px; height: 300px; border-radius: 15px;">
                        <?php else : ?>
                        ...
                        <div class="card-body">
                            <table class="table table-borderless no-margin table-striped">
                                ...
                                <tr>
                                    ...
                                    <td><span id="Tempat_lahir"><?= $admin['tempat_lahir'] ?></span></td>
                                </tr>
                                <tr>
                                    <th class="text-left">No. Handphone</th>
                                    <td><span id="no-hp"><?= $admin['No_telpon'] ?></span></td>
                                </tr>
                                <tr>
                            ...
                            <?= anchor('admin/profile/password', '<div class="btn btn-sm btn-primary  mr-1 ml-1 mb-1"><i class="fa fa-lock"></i> Ganti Password</div>') ?>
                        </div>
                    </div>
                </div>
            </div>
