...
class User_model extends CI_Model
{
    ...
    public function get_detail_admin($id, $level)
    {
        ...
        $this->db->join('tbl_tu_admin', "tb_user.id_user = tbl_tu_admin.id_user", 'left');
    ...
    public function get_detail_guru($id, $level)
    {
        ...
        $this->db->where('tb_user.id_user', $id);
        $this->db->where('tb_user.level', $level);
        $this->db->join('tbl_guru', "tb_user.id_user = tbl_guru.id_user", 'left');
        return $this->db->get()->row_array();
    }
    ...
    public function get_detail_siswa($id, $level)
    {
        ...
        $this->db->join('tbl_siswa ts', "tu.id_user = ts.id_user", 'left');
    ...
    public function input_data($photo)
    {
        ...
        $this->db->insert('tbl_tu_admin', $data);
    }
    ...
    public function edit_admin($id, $photo)
    {
        ...
        $this->db->where('id_user', $id);
        $this->db->update('tbl_tu_admin', $data_admin);
    }
    ...
    private function _get_datatables_query($level, $levels)
    {
        ...
        $table_join = $level == 'admin' ? 'tbl_tu_admin' : ($level == 'guru' ? 'tbl_guru' : ($level == 'kepala sekolah' ? 'tbl_guru' : ($level == 'siswa' ? 'tbl_siswa' : NULL)));
